...
int breathe = 15;                 // used in 'breathing' the LED's.
...
void handleBreathe() {
  ...
  // breathe the LED from 15 = off to 80 = fairly bright, change values if needed
  if ( (breathe >= 80 || breathe <= 15) ) {
    ...
    if (timeDiff < 300) {
      delay(300-timeDiff);  // Pause at beginning and end of each breath
    }
  }
  else {
